...
def get_stock_ledger_entries(filters, items):
	...
	return frappe.db.sql("""select concat_ws(" ", sle.posting_date, sle.posting_time) as date, dni.price_list_rate as price,
		...
		LEFT JOIN `tabDelivery Note Item` as dni on dni.item_code = sle.item_code and dni.parent = sle.voucher_no
		where
